...
<?php
if(@$_GET['q']){
    echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true">
          </span>&nbsp;'.@$_GET['q'].'</span>';
}
else{
    echo' 
...
<div class="col-md-10">
<a href="mailto:manalaboelez550@gmail.com" style="color:#000000">manalaboelez550@gmail.com</a><br /><br />
...
<a href="http://localhost/online-exam/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://www.facebook.com/nour.hatem.1253" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">manalHatem</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">000000000</h4>
		<h4 style="font-family:'typo' ">manalaboelez550@gmail.com</h4>
		</div></div>
		</p>
      </div>
